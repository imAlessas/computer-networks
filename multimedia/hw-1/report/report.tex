...
Seguedo le direttive della task numero 5, calcoliamo ora la codifica esponenziale di Golomb (detta anche \textsl{exp-Golomb})
...
rint(f"The bitrate of the simple coding is {exp_golomb_bpp:.4f}\n")
\end{lstlisting}
